 ...
 * @param {{subject:Object,entries:Object[],onSubject:Function,progress?:Object,progressDescription?:string}} props
 */
export default function LogbookSubjectCard({ subject, entries, onSubject, progress: suppliedProgress, progressDescription }) {
        const SubjectIcon = SUBJECT_ICONS[subject.code] || (subject.phase === 'Phase III' ? Stethoscope : BookOpen)
        const progress = suppliedProgress || subjectProgress(entries, subject)
